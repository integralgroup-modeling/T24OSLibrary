...
schedule_week_hash.each do |sch|
  ...
  schedule_week.setSummerDesignDaySchedule(findObject(schedule_days,sch[:htgdd]))
  schedule_week.setWinterDesignDaySchedule(findObject(schedule_days,sch[:clgdd]))
end
...
schedule_group_hash.each do |sch_grp|
  ...
  default_schedule_set.setNumberofPeopleSchedule(findObject(schedule_years,sch_grp[:occschref]))
  default_schedule_set.setElectricEquipmentSchedule(findObject(schedule_years,sch_grp[:recptschref]))
  default_schedule_set.setHotWaterEquipmentSchedule(findObject(schedule_years,sch_grp[:hotwtrhtgschref]))
  default_schedule_set.setLightingSchedule(findObject(schedule_years,sch_grp[:intltgregschref]))
  default_schedule_set.setGasEquipmentSchedule(findObject(schedule_years,sch_grp[:procgasschref]))
  default_schedule_set.setInfiltrationSchedule(findObject(schedule_years,sch_grp[:infschref]))
  default_schedule_set.setHoursofOperationSchedule(findObject(schedule_years,sch_grp[:availschref]))
end
